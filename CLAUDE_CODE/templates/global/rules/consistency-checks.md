...
> **Source of truth:** [`AGENTS/[APP]__STATIC_ANALYSIS.md`](https://github.com/Ardi-Agents/architect-coding-playbook/blob/main/AGENTS/%5BAPP%5D__STATIC_ANALYSIS.md)
...
> Detailed per-check methodology lives in [`AGENTS/[APP]__STATIC_ANALYSIS.md`](https://github.com/Ardi-Agents/architect-coding-playbook/blob/main/AGENTS/%5BAPP%5D__STATIC_ANALYSIS.md).
